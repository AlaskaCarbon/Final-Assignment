...
function rollDie() {
    // Generate a random decimal number between 0 (inclusive) and 1 (exclusive) page 185 from the textbook
    ...
    var dieNumber = Math.floor(scaledNumber) + 1; 
...
function displayDice(die1, die2) {
    // Get the dice container div by its id page 124 of the textbook
    var diceContainer = document.getElementById("diceContainer"); // Gets the div where dice images will be displayed
    // Clear any previous content in the dice container
    diceContainer.innerHTML = ""; // Clears previous images from the diceContainer

    // Create image elements for both dice Chapter 25 of the textbook
    ...
    // Append the images to the dice container div page 423 of the textbook
